...
import com.example.roomdatabase.Monday
import com.example.roomdatabase.R
import com.example.roomdatabase.id

class MondayListAdapter(val gradeViewModel: GradeViewModel, val applicationContext: Context) : ListAdapter<Monday, MondayListAdapter.GradeViewHolder>(
    GradesComparator()
) {
    ...
    class GradeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(record: Monday, gradeViewModel: GradeViewModel, applicationContext: Context) {
    ...
    class GradesComparator : DiffUtil.ItemCallback<Monday>() {
        override fun areItemsTheSame(oldItem: Monday, newItem: Monday): Boolean {
            return oldItem === newItem
        }
        override fun areContentsTheSame(oldItem: Monday, newItem: Monday): Boolean {
