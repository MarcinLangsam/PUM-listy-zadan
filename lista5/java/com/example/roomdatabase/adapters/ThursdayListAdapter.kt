...
import com.example.roomdatabase.Thursday
import com.example.roomdatabase.id

class ThursdayListAdapter(val gradeViewModel: GradeViewModel, val applicationContext: Context) : ListAdapter<Thursday, ThursdayListAdapter.GradeViewHolder>(
    GradesComparator()
) {
    ...
    class GradeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(record: Thursday, gradeViewModel: GradeViewModel, applicationContext: Context) {
    ...
    class GradesComparator : DiffUtil.ItemCallback<Thursday>() {
        override fun areItemsTheSame(oldItem: Thursday, newItem: Thursday): Boolean {
            return oldItem === newItem
        }
        override fun areContentsTheSame(oldItem: Thursday, newItem: Thursday): Boolean {
