...
import com.example.roomdatabase.Friday
import com.example.roomdatabase.GradeViewModel
import com.example.roomdatabase.R
import com.example.roomdatabase.id

class FridayListAdapter(val gradeViewModel: GradeViewModel, val applicationContext: Context) : ListAdapter<Friday, FridayListAdapter.GradeViewHolder>(
    GradesComparator()
) {
    ...
    class GradeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(record: Friday, gradeViewModel: GradeViewModel, applicationContext: Context) {
    ...
    class GradesComparator : DiffUtil.ItemCallback<Friday>() {
        override fun areItemsTheSame(oldItem: Friday, newItem: Friday): Boolean {
            return oldItem === newItem
        }
        override fun areContentsTheSame(oldItem: Friday, newItem: Friday): Boolean {
